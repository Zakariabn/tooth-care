      ...
      <div className="w-[400px] flex flex-col justify-center items-center bg-slate-100 shadow-md border border-gray-300 rounded-md px-5 py-10 mt-10 ">
        ...
        <div className="mb-8 ">
          <p className="text-justify">
            আমি জাকারিয়া, আমার কোন জিনিসকে অটোমেটিক করতে অনেক ভালো লাগে ।
            আমি গেম খেলতে অনেক পছন্দ করি । সাউথইস্ট ইউনিভার্সিটি তে সিএসই করতেছি 5
            সেমিস্টার, <br /><br />  ছাত্র থাকা অবস্থায় মার্কেট কেমন, জব কেমন, তাদের রিকোয়ারমেন্ট কি থাকে, এজন্য নিজেকে প্রস্তুত করছি এবং  নিজেকে যতোটুকু
            প্রিপেয়ার করা দরকার সেটা করার সর্বাত্মক চেষ্টা করছি । <br /><br /> আগামী তিন থেকে পাঁচ মাসে আমার টার্গেট front-end এবং back-end এর Basic এবং Intermediate লেভেলের concept গুলোতে Confident হওয়া । এবং ওয়েব সফটওয়্যার রিলেটেড কোন কোম্পানির সাথে যুক্ত হওয়া ।
          </p>
        </div>
